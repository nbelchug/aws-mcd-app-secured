  ...
  /usr/bin/docker run -e "HOST_NAME=$ownip" -e "SERVICE_PORT=10000" -p 10000:8080 -d descartesresearch/teastore-registry
  /usr/bin/docker run -p 3306:3306 -d descartesresearch/teastore-db
